...
function buildVtonPrompt(garment: {
  ...
  return (
    "Act as a professional post-production retoucher for a fashion e-commerce studio performing a virtual garment try-on composite. You are given two images. Image 1 is a photograph of a real person — the identity and scene reference. Image 2 shows a garment or outfit on its own — the apparel reference only. Generate one new photograph of the exact person from Image 1, wearing the exact garment(s) from Image 2, as if photographed together in a single real photoshoot. Prioritize extreme photographic naturalness over stylization — this must be indistinguishable from an unedited photo." +
    catalogBlock +
    "CORE PRINCIPLE — treat Image 1 as ground truth for everything except the garment area(s) being replaced. Never invent, add, remove, smooth over, or guess at any physical detail — skin marks, body shape, proportions, texture, asymmetries — that isn't visible and verifiable in Image 1." +
    "FRAMING AND FIELD OF VIEW OVERRIDE (CRITICAL) — Image 1's camera distance, focal length, angle, and framing crop boundaries are ABSOLUTE." +
    "- If Image 1 is cropped (e.g., waist-up, torso-up, or knees-up) and does NOT show the full body, DO NOT zoom out, DO NOT change the camera distance, and DO NOT compress the person's body to force lower-body items into the frame." +
    "- Any garment or accessory listed in the catalog that falls outside Image 1's crop boundary (such as shoes/sneakers on a knee-up shot, or pants cuffs) must simply be naturally cut off by the edge of the frame." +
    "- Maintain true human vertical scale: head-to-torso and torso-to-leg proportions must remain 100% true to Image 1. Never compress limbs, squish torsos, or shorten necks to fit an outfit into frame." +
    "GARMENT SCOPE — replace ONLY the body region(s) the catalog piece(s) actually occupy within the existing crop of Image 1. Every part of the person's body, clothing, and accessories outside that region must remain exactly as shown in Image 1." +
    "LAYERING AND POSITIONING — follow any explicit layering/tucking/positioning instruction from the catalog information above. Keep the overshirt open, t-shirt untucked, and pants waistband visible." +
    "FIT AND SILHOUETTE — follow the relaxed fit specified. The garment should hang, drape, and structure itself naturally on this specific person's body type and pose without altering their underlying silhouette." +
    "FABRIC PHYSICS — render drape, tension, puckering, and gravity consistent with lightweight crinkled linen/cotton for the overshirt, jersey knit for the t-shirt, and woven cotton for the pants. Shadows and highlights must match Image 1's existing light source and direction exactly." +
    "IDENTITY LOCK — keep unchanged from Image 1: facial structure, neck length, expression, skin tone and texture, natural height, body shape, skeletal proportions, pose, posture, hair, and exact crop boundaries." +
    "SCENE INTEGRITY — keep background, lighting direction, ambient color temperature, camera angle, and focal length identical to Image 1." +
    "DO NOT:" +
    "- Zoom out, widen the field of view, or extend the canvas to include out-of-frame items (like shoes on a knee-up portrait)." +
    "- Compress, shrink, or distort the person's skeleton, neck, torso, or leg length to fit clothes into frame." +
    "- Alter the person's identity, facial features, or body dimensions." +
    "- Change the background, lighting, or crop boundaries of Image 1." +
    "- Output more than one image or any commentary."
  );
}
