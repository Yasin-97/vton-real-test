...
function buildVtonPrompt(garment: {
  ...
  return (
    ...
    "COLOR & DYE FIDELITY — sample exact fabric colors, dye shades, color saturation, and denim washes directly from the pixels of Image 2. Do not shift, re-interpret, or normalize any garment colors." +
