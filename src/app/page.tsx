...
const PRODUCTS: ProductItem[] = [
  ...
  },
  {
    ...
    promptDescription:
      "Treat the outfit as two distinct garments: a pastel lime-green long-sleeve button-down shirt and high-rise white straight-leg five-pocket jeans. Preserve the shirt's relaxed regular silhouette, conventional shoulder construction, pointed collar, full front button placket, long sleeves, and curved shirttail hem. When worn, the shirt MUST hang freely OVER the jeans and MUST extend low enough at the front to completely cover the jeans' waistband button, zipper/fly, and entire upper fastening section, continuing down over the upper-mid-hip area. Do not allow the shirt hem to rise above, expose, or reveal the jeans button or zipper. Do not tuck the shirt in, half-tuck it, crop it, or pull it upward; the shirt must remain untucked and visibly overlap the jeans by a substantial amount at the front. Preserve the natural loose drape and soft overlap of the shirt over the upper hip. Style both sleeves rolled upward to the forearms with substantial clean fabric folds forming soft rolled cuffs; keep the collar flat and naturally structured. The shirt is a pale yellow-green/lime pastel tone with a smooth lightweight-to-medium-weight woven shirting fabric, soft matte finish, fine subtle weave, fluid natural drape, and gentle folds around the torso, lower hem, sleeves, and rolled cuffs. On the wearer's left chest, reproduce the small dark navy/black embroidered equestrian polo-player emblem showing a mounted rider holding a raised mallet; render it as compact stitched embroidery directly into the fabric with no surrounding patch and no additional lettering. The inner neck label contains visible small text including 'LAUREN RALPH'; treat it only as an internal garment label and do not add exterior text. The jeans are clean solid white/off-white denim with a high-rise waistband, belt loops, button closure, zip fly, classic five-pocket construction, front rivets, roomy upper leg, and straight relaxed legs. Preserve the jeans as medium-weight cotton denim with a smooth twill texture, structured but not rigid drape, minimal fading, and clean white coloration. When worn, keep the jeans underneath the shirt so that the shirt completely conceals the front button-and-zip fastening area; the jeans should emerge only below the shirt's lower front hem. Keep the jeans full length with straight hems, falling naturally toward footwear with a clean slight break rather than cuffing, heavy stacking, or tucking into shoes. No footwear is present in the reference. Preserve the exact lime-green color, white denim tone, shirt proportions, collar and button construction, sleeve-roll position, curved hem, embroidered rider emblem, pocket architecture, fabric texture, folds, and overall silhouette while enforcing the shirt-over-jeans layering rule exactly.",
    tags: [
